...
import 'package:pklonline/viewmodels/forgot_pw_view_model.dart';
...
class _ForgotPwViewState extends State<ForgotPwView> {
  ...
  void initState() {
    ...
    super.initState();
//    Provider.of<ForgotPwViewModel>(context,listen: false).getAreas();
//  context.read<ForgotPwViewModel>().getAreas();
  }
